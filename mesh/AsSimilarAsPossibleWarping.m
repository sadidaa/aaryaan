classdef AsSimilarAsPossibleWarping < handle
    ...
    methods (Access = public)
        function obj = AsSimilarAsPossibleWarping(height,width,quadWidth,quadHeight,weight)
            ...
            obj.num_smooth_cons = (obj.height-2)*(obj.width-2)*16 + (2*(obj.width+obj.height)-8)*8+4*4;
        ...
        function warp = Warp(obj,Img,gap)
            ...
            for i=1:obj.height-1
                for j=1:obj.width-1
                   ...
                   temp = quadWarp(obj,Img,qd1,qd2);

                   if strcmp(temp,"bypass")
                    warp =  "bypass";
                    return
                  end
        ...
        function homos = CalcHomos(obj)
            homos = zeros(obj.height,obj.width,3,3);
    ...
    methods (Access = private) %functions of solving as similar as possible warping
        ...
        function CreateSmoothCons(obj,weight)
           obj.rowCount = 0;
           i=0;j=0;
           obj.addCoefficient_5(i,j,weight);
           obj.addCoefficient_6(i,j,weight);
           
           i=0;j=obj.width-1;
           obj.addCoefficient_7(i,j,weight);
           obj.addCoefficient_8(i,j,weight);
          
           i=obj.height-1;j=0;
           obj.addCoefficient_3(i,j,weight);
           obj.addCoefficient_4(i,j,weight);
           
           i=obj.height-1;j=obj.width-1;
           obj.addCoefficient_1(i,j,weight);
           obj.addCoefficient_2(i,j,weight);
        ...
        function b = CreateDataCons(obj)
           len = length(obj.dataterm_element_i);
...
%             rowCount = rowCount + 1;
    ...
    methods (Access = private)%functions of warping
        function out = quadWarp(obj,im,q1,q2)
             ...
             temp = myWarp(minx,maxx,miny,maxy,im,obj.warpIm,H,obj.gap);
             if strcmp(temp,'bypass')
                out = "bypass";
                return
              end
